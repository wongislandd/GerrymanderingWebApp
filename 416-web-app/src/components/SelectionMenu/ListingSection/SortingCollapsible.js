...
class SortingCollapsible extends Component {
  ...
  handleSortClick(method) {
    if (this.props.DistrictingSortMethod.method == method) {
      if (
        this.props.DistrictingSortMethod.direction ==
        SelectionMenuUtilities.SORT_DIRECTIONS.DESCENDING
      ) {
        this.props.setDistrictingSortMethod(
          method,
          SelectionMenuUtilities.SORT_DIRECTIONS.ASCENDING
        );
        return;
      }
    }
      ...
      <CollapsibleItem
        ...
        header={
          <Row className="ListingColumnsContainer align-items-start">
            ...
            <Col s={2}>
              <Row>OF Score</Row>
              {this.props.showSortOption ? (
                <Row>
                  <SwapVertIcon
                    style={{ fontSize: 40 }}
                    className="swapSortOrderIcon"
                    onClick={() =>
              ...
              {this.props.showSortOption ? (
                <Row>
                  <SwapVertIcon
                    ...
                    onClick={() =>
                      this.handleSortClick(
                        SelectionMenuUtilities.SORT_METHODS.POPULATION_EQUALITY
                      )
                    }
                  />
                </Row>
              ...
              {this.props.showSortOption ? (
                <Row>
                  <SwapVertIcon
                    ...
                    onClick={() =>
                      this.handleSortClick(
                        SelectionMenuUtilities.SORT_METHODS
              ...
              {this.props.showSortOption ? (
                <Row>
                  <SwapVertIcon
                    ...
                    onClick={() =>
                      this.handleSortClick(
                        SelectionMenuUtilities.SORT_METHODS.SPLIT_COUNTIES
                      )
                    }
                  />
                </Row>
